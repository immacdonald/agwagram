...
def link_data(tweets):
    ...
    for tweet in tweets:
        ...
        cleaned_semantic_sentiment = tweet["bloc"]["bloc_sequences_short"][
        ...
        data = {
            ...
            "content_syntactic": tweet["bloc"]["bloc_sequences_short"][
                "content_syntactic"
            ][1:-1],
            "content_semantic_entity": tweet["bloc"]["bloc_sequences_short"][
