...
export const BarChart = () => <BarChartSVG/>;
export const Chart = () => <ChartSVG />;
export const DarkMode = () => <DarkModeSVG />;
export const Dataset = () => <DatasetSVG />;
export const Group = () => <GroupSVG />;
export const Hub = () => <HubSVG />;
export const Link = () => <LinkSVG />;
export const Pause = () => <PauseSVG />;
export const Person = () => <PersonSVG />;
export const Search = () => <SearchSVG />;
export const Timeline = () => <TimelineSVG />;