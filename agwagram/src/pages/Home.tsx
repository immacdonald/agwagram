    ...
    <>
      <section>
        ...
        <p>
          ...
          the global rise of misinformation, it offers a unique solution to
          track shifts in behavior, powered by the novel BLOC language
          algorithm, and identify potential bot accounts with ease. Capable of
          detecting a broad range of legitimate and suspicious behaviors, as
          well as accounts which display both, Agwagram offers a flexible and
          generalizable method for analyzing Twitter accounts - making it an
      ...
      <section>
        ...
        <p>
          ...
          detect suspicious behaviors without requiring specific fine-tuning.
          This is in contrast to other methods that rely on features designed to
          target specific types of malicious behaviors, which may not generalize
          well to other types. BLOC can represent a broad range of legitimate
          and suspicious behaviors, making it a versatile tool for studying and
        ...
        <p>
          ...
          significantly fewer features. For more information, please see the
          BLOC paper:{" "}
