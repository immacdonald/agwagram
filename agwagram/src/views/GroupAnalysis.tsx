...
import { GridCard, GridCardSize } from '../components/GridCard';
...
const GroupAnalysis: React.FC<GroupAnalysisProps> = ({ accounts, totalTweets, topBlocWords, topTimes, pairwiseSim }) => {
	return (
		<>
			<GridCard title="Accounts Overview" Icon={GroupFilled} size={GridCardSize.Full}>
				...
				<p>
					...
					generated using {totalTweets} tweets.
				</p>
			</GridCard>
			...
			<GridCard title="Pairwise Similarity" Icon={Hub}>
				<table>
					<thead>
						<tr>
							<th>Similarity</th>
